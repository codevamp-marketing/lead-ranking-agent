...
SUPABASE_URL         = "https://rfwqmioveboohgqplvjp.supabase.co"

# ✅ Service role key — gives this agent write access + bypasses RLS.
#    Ask Faraz / check Supabase Dashboard → Project Settings → API
SUPABASE_SERVICE_KEY = "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6InJmd3FtaW92ZWJvb2hncXBsdmpwIiwicm9sZSI6InNlcnZpY2Vfcm9sZSIsImlhdCI6MTc3MTkxNTE2OCwiZXhwIjoyMDg3NDkxMTY4fQ.GXS_rY5WoHbdeHrrDOuO4BmMngM3s46N6Z1DO57TsuY"
...
SUPABASE_ANON_KEY    = (
    ...
    ".eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6InJmd3FtaW92ZWJvb2hncXBsdmpwIiwi"
    "cm9sZSI6ImFub24iLCJpYXQiOjE3NzE5MTUxNjgsImV4cCI6MjA4NzQ5MTE2OH0"
    ".vtHb8eZvqK04en4hiJhk_NeAPGRzrVvblcAbPpUJaJM"
)

# CRM NestJS API — use the deployed URL in production,
#    or http://localhost:11000/api/v1 if Faraz's backend is running locally
CRM_API_BASE = "https://crm-core-server.onrender.com/api/v1"
